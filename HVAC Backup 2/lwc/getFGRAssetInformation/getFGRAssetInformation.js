...
import fetchAssetsFromSAP from "@salesforce/apex/GetFGRInformationController.fetchAssetsFromSAP";
import fetchSplitAssetsFromSAP from "@salesforce/apex/GetFGRInformationController.fetchAssetsFromSAP";
...
export default class GetFGRAssetInformation extends NavigationMixin(LightningElement) {
    @api recordId;
    ...
    connectedCallback() {
        console.log('disable',this.disableSerial);
        if(this.modelNumber!=null && this.modelNumber!=undefined && this.modelNumber!='' && this.serialNumber!='' && this.serialNumber!=null && this.serialNumber!=undefined){
        ...
        fetchAssetsFromSAP({
            ...
            .then((result) => {
                ...
                if (
                    ...
                    this.showToast("Error", "No Invoice details found", "error");
                    this.showSpinner = false;
                    this.firstPage = true;
                    this.secondPage = false;
                }
            ...
            // Assign these values to variables
                    ...
                    this.invoiceDate = (INVOICE_DATE!=null && INVOICE_DATE!=undefined && INVOICE_DATE!='' ) ? INVOICE_DATE : null;
