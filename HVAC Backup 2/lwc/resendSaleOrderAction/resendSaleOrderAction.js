...
import sendToSAP from '@salesforce/apex/SendSaleOrderDetailsAPI.sendSaleOrderQuickAction';


export default class resendSaleOrderAction extends LightningElement {

    @api recordId; 
    @track soSuccessMessage = 'SO Details sent to SAP successfully';
