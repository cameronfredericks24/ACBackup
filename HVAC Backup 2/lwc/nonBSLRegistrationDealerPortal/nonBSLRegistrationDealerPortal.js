...
export default class NonBSLRegistrationDealerPortal extends NavigationMixin(LightningElement) {
    @track make;
    @track model;
    @track serial;
   ...
   handleModelNumberChangeCustomLookup(event) {
    ...
    handleSubmit() {
        ...
        console.log('showSpinner 236 -- ' + this.showSpinner);
        ...
        if (!this.make || !this.model || !this.serial || !this.installationDate  || !this.prodName || !this.installationDate) {

            console.log('showSpinner 257-- ' + this.showSpinner);
        ...
        checkExistingAsset({ serialNumber: this.serial })
            .then(result => {
                ...
                console.log('showSpinner 280-- ' + this.showSpinner);
                ...
                if (result === true) {
                    ...
                    console.log('showSpinner 296-- ' + this.showSpinner);
                    ...
                    createOrUpdateProductAndAsset({
                        ...
                        .then(result => {
                            ...
                            console.log('showSpinner 318-- ' + this.showSpinner);
